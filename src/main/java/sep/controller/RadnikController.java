...
import sep.dto.LoggedInUserDTO;
import sep.dto.LoginDTO;
import sep.model.Radnik;
import sep.model.Role;
import sep.service.RadnikService;
...
public class RadnikController {
	...
	public ResponseEntity<?> login(@RequestBody LoginDTO loginDTO) {
		...
		return new ResponseEntity<>(new LoggedInUserDTO(radnik.getIme(), role, radnik.getId()),HttpStatus.OK);
	}
